...
import kotlinx.android.synthetic.main.fragment_taqiqlovchi.view.*

class TaqiqlovchiFragment : Fragment() {
    lateinit var root:View
    lateinit var targets:ArrayList<Target>
    lateinit var myDbHelper: MyDbHelper
    lateinit var myReciycle: MyReciycle
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        root = inflater.inflate(R.layout.fragment_taqiqlovchi, container, false)
    ...
    private fun sync(){
        ...
        root.taqiqlovchi_recylce.adapter = myReciycle
    }
